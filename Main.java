...
public class Main {
    public static void main(String[] args) {
        ...
        album arjitAlbum=new album("Arjith's album","Arjit Singh");
        ...
        System.out.println(arjitAlbum.addSongToPlaylist("Kesaria",myPlayList));
        System.out.println(arjitAlbum.addSongToPlaylist(2,myPlayList));
        System.out.println(arjitAlbum.addSongToPlaylist(5,myPlayList));  // wrong song
        System.out.println(alanAlbum.addSongToPlaylist("Alone",myPlayList));
        System.out.println(alanAlbum.addSongToPlaylist(3,myPlayList));
